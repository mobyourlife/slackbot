...
function ProtoBot () {
   ...
   */
  this.action = function (verb, predicate, action) {
  ...
  this.talk = function (phrase) {
    ...
    if (what) {
      if (what.action) {
        return DoSomething.bind(this)(what)
  ...
  this.action('consultar', 'status', actions.consultarStatus)
}
